...
class UserInfoFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'relation' => ['Marriage', 'A serious relationship', 'Something casual', 'Prefer not ot say', 'Not sure yet'][array_rand(['Marriage', 'A serious relationship', 'Something casual', 'Prefer not ot say', 'Not sure yet'])],
            'education' => fake()->name(),
